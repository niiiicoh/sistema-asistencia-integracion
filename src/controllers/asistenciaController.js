...
module.exports = service => ({
  entrada: async (req, res) => res.status(201).json(await service.registrarEntrada(req.usuario.idUsuario, req.ip)),
  salida: async (req, res) => res.status(201).json(await service.registrarSalida(req.usuario.idUsuario, req.ip)),
