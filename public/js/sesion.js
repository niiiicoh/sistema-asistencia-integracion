window.sesionLista = (async () => {
  try {
    ...
    document.querySelectorAll('[data-empleado]').forEach(element => { element.hidden = usuario.rol === 'ADMINISTRADOR'; });
    document.body.classList.toggle('vista-empleado', usuario.rol !== 'ADMINISTRADOR');
